...
template bind_val(statement: Statement, i: idx_t, val: bool): Error = duckdb_bind_boolean(statement, i, val)
...
proc execute*[T: Values](con: Connection, statement: Statement, args: T): QueryResult {.discardable.} =
...
proc execute*[T: Values](con: Connection, query: Query, args: T): QueryResult {.discardable.}=
